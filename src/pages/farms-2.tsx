...
async function buttonApprove(num) {
  ...
  if (num < 6){
    var stake_ad = "0xcf10731b92C17C357B201BAFD56B226967971B0C";
  } else if(num == 8){
    var stake_ad = "0x8645F4c2081e98505888A1B9E64f612029150c5B";
  } else if(num == 9){
    var stake_ad = "0x461a884970f430128CdDD40CCf92D4ce562a04B0";
  } else {
    var stake_ad = "0xbEe38fa110f76d9385Fa96d32Cb9914DDAc4B57d";
  }
...
async function buttonUnstake(num, amount, affiliateId: string) {
  ...
  if(affiliateId){
    if (num == 1){ //AFFI------------------------------------------------------apy_a_BTC
      ...
      var dataFie = stake_contract.methods.unpool_wbtc(heko, affiliateId).encodeABI(); 
      ...
      var dataFie = stake_contract.methods.unpool_weth(heko, affiliateId).encodeABI(); 
      ...
      var dataFie = stake_contract.methods.unpool_usdt(heko, affiliateId).encodeABI(); 
      ...
      var dataFie = stake_contract.methods.unpool_lot(heko, affiliateId).encodeABI(); 
      ...
      var dataFie = stake_contract.methods.unpool_dai(heko, affiliateId).encodeABI(); 
      ...
      var dataFie = stake_contract.methods.unpool_atom(heko, affiliateId).encodeABI(); 
    ...
    if (num == 1){ //NON--AFFI------------------------------------------------------apy_a_BTC
      ...
      var dataFie = stake_contract.methods.unpool_wbtc(heko, 0).encodeABI(); 
      console.log("UNPOOL BTC");
      ...
      var dataFie = stake_contract.methods.unpool_weth(heko, 0).encodeABI(); 
      console.log("UNPOOL WETH");
      ...
      var apy_d = await stake_contract.methods.check_apy_c(accounts[0]).call();
      console.log(apy_d);
      var dataFie = stake_contract.methods.unpool_usdt(heko, 0).encodeABI(); 
      console.log("UNPOOL USDT");
      ...
      var dataFie = stake_contract.methods.unpool_lot(heko, 0).encodeABI(); 
      console.log("UNPOOL BUSD");
      ...
      var dataFie = stake_contract.methods.unpool_atom(heko, 0).encodeABI(); 
      console.log("UNPOOL ATOM");
...
async function checkStatus(num) {
  ...
  if (num == 1){ //BTC
    ...
    var claimable_token = await stake_contract.methods.claimable_wbtc(accounts[0], balance).call(); //WBTC
    console.log("BTC");
  } else if( num == 2) { //WETH
    var token_add = eth_lp;
    let token_contract = new web3.eth.Contract(tokenABI, token_add);
    var balance = await token_contract.methods.balanceOf(accounts[0]).call();
    var claimable_token = await stake_contract.methods.claimable_weth(accounts[0], balance).call(); //WBTC
    ...
    let token_contract = new web3.eth.Contract(tokenABI, token_add);
    var balance = await token_contract.methods.balanceOf(accounts[0]).call();
    var claimable_token = await stake_contract.methods.claimable_usdt(accounts[0], balance).call(); //
    var time = await stake_contract.methods.check_apy_c(accounts[0]).call(); //
    console.log(claimable_token);
    console.log(time);
    console.log("USDT");
  }  else if( num == 5) { //BUSD
    ...
    let token_contract = new web3.eth.Contract(tokenABI, token_add);
    var balance = await token_contract.methods.balanceOf(accounts[0]).call();
    var claimable_token = await stake_contract.methods.claimable_lot(accounts[0], balance).call(); //LOT
    var staking_flag = await stake_contract.methods.status_list(accounts[0]).call()["staking_flag"]; ; //LOT
    console.log("LOT");
  } else if( num == 7) { //DAI
    var token_add = dai_lp;
    var claimable_token = await stake_contract.methods.claimable_dai(accounts[0]).call(); //DAI
    console.log("DAI");
  } else if( num == 8) { //DF
    var token_add = df_lp;
    var claimable_token = await stake_contract.methods.claimable_df(accounts[0]).call(); //DF
    var timer = await stake_contract.methods.check_apy_a(accounts[0]).call(); //DF
    console.log(timer);
    var staking_flag = await stake_contract.methods.status_list(accounts[0]).call()["staking_flag"]; //DF
    ...
    let token_contract = new web3.eth.Contract(tokenABI, token_add);
    var balance = await token_contract.methods.balanceOf(accounts[0]).call();
    var claimable_token = await stake_contract.methods.claimable_atom(accounts[0], balance).call(); //ATOM
    var staking_flag = await stake_contract.methods.status_list(accounts[0]).call()["staking_flag"]; //ATOM
    console.log("ATOM");
    console.log(claimable_token);
  } else {
